...
<body style="margin-right:5px;">
    ...
    <div>
        ...
        <a href="javascript:void(0);" onclick="showAddCarModal()" class="sui-btn  btn-success" style="width:100px;  margin-top: 40px; margin-left: 8px;">增加</a>
        <a href="javascript:void(0);" onclick="deleteCar()" class="sui-btn  btn-danger" style="width:100px;  margin-top: 40px; margin-left: 8px;">删除</a>
    </div>
